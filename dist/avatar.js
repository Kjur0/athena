...
const M = ({
  ...
  ({
    ...
    const m = n === "initials" ? I(i) : "", E = !!t && !o, w = !!m, f = !!(i || a), v = f ? i ? `${i} avatar` : a : void 0;
    return /* @__PURE__ */ C(
      "div",
      {
        ref: g,
        ...
        "data-slot": "avatar",
        "data-testid": p,
        className: d(N({ size: r, className: l })),
        ...u,
        children: E ? /* @__PURE__ */ C(
          ...
          "div",
          {
            ...
            "aria-hidden": "true",
            children: w ? m : /* @__PURE__ */ C("span", { className: d("size-full", L), children: h === "female" ? /* @__PURE__ */ C(y, {}) : /* @__PURE__ */ C(b, {}) })
          }
        )
      }
    );
